...
const ButtonWhite = (props) => {
  return (
    <div className=" px-4 py-3 hover:gap-8 transition-all ease-in hover:scale-105 gap-4 border-2 w-fit flex items-center border-white text-white rounded-full">
      {props.text}
      <span>
        <svg
